...
def test_update_feed_for_podcast_apps_does_not_include_duplicates_in_podcast_feed(
        ...
        storage,
        mocker,
        cleanup_test_feed_for_podcast_apps
):
    # Get the feed for podcast apps and set the title of one item.
    ...
    duplicate_item_title.text = "TF - This is a duplicate post"
    # Save this feed
    ...
    duplicate_beyondwords_item_title.text = "TF - This is a duplicate post"
    ...
    assert "TF - This is a duplicate post" not in feed_titles
