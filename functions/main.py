...
def af_all(a=None, b=None):
    ...
    generate_podcast_feed(af_config(), True)
...
def ea_all(a=None, b=None):
    ...
    generate_podcast_feed(ea_config(), True)
...
def lw_all(a=None, b=None):
    ...
    generate_podcast_feed(lw_config(), True)
